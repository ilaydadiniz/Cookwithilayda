        ...
        child: ListView(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: 16, top: 25, right: 16),
              child: Text(
                " Bu uygulama Dr. Öğretim Üyesi Ahmet Cevahir tarafından yürütülen 3301456 kodlu MOBİL PROGRAMLAMA dersi kapsamında 193311031 numaralı İlayda Diniz tarafından 30 Nisan 2021 günü yapılmıştır.",
                style: TextStyle(
                    fontWeight: FontWeight.w500,
                    fontSize: 17,
                    color: Colors.black),
